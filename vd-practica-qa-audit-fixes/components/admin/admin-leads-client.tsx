...
function getStatusBadgeStyles(status: string) {
  switch (status) {
    case "Nou":
      return "bg-primary text-primary-foreground border-blue-200";
    case "Contactat":
      ...
      <div className="relative w-full max-w-[520px] h-full bg-card border-l border-border shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b border-border px-6 py-4 bg-background">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary font-bold text-primary-foreground shadow-lg text-sm">
                  ...
                  <form onSubmit={handleAddNote} className="bg-background border border-border rounded-xl p-4 space-y-2">
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="flex items-center gap-1 rounded-lg bg-primary text-primary-foreground px-3 py-1.5 text-[11px] font-bold hover:bg-primary/90 disabled:opacity-50 transition-colors shadow-lg"
                      >
    ...
    <div className="min-h-full p-7" style={{ fontFamily: "'Outfit', 'Inter', sans-serif" }}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-7">
        {[
          ...
          { label: "Noi", val: stats.newLeads, icon: AlertCircle, color: "text-primary-foreground bg-primary border-blue-100" },
        ...
        <div className="space-y-6">
          ...
          {aiInsights && (
            <div className="rounded-2xl border border-border bg-card p-5 shadow-lg space-y-4">
              <div className="flex items-center gap-2">
                <div className="flex size-7 items-center justify-center rounded-lg bg-primary text-primary-foreground shadow-lg">
