      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-border bg-card shadow-2xl flex flex-col" style={{ maxHeight: "90vh" }}>
        ...
        <div className="px-6 py-4 border-t border-secondary/30 flex-shrink-0">
          <button
            ...
            disabled={loading}
            className="flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-primary text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-60"
          >
      ...
      <div className="flex flex-shrink-0 items-center justify-between border-b border-secondary/30 bg-secondary/10 backdrop-blur-md px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-[12px] font-semibold text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-60"
          >
      ...
      <div className="mb-5 flex flex-wrap items-center gap-4">
        {currentUser.role !== "VIEWER" && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-[13px] font-semibold text-primary-foreground hover:bg-primary/90 transition-colors shadow-lg"
          >
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-secondary/30 bg-secondary/10 backdrop-blur-md py-20 text-center shadow-lg">
          ...
          {!search && currentUser.role !== "VIEWER" && (
            <button
              onClick={() => { setEditingQ(null); setShowModal(true); }}
              className="mt-1 flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-[13px] font-semibold text-primary-foreground hover:bg-primary/90"
            >
              <Plus className="size-3.5" /> Chestionar Nou
            </button>
          )}
